    ...
    public class ProposalServiceIntegrationTests
    {
        ...
        public ProposalServiceIntegrationTests()
        {
            ...
            _stateService
                ...
                .ReturnsAsync((Guid id, ShipmentStatus to, object? c, object? t, Guid? p, string? r, Func<ShipmentStatusChangedEvent, CancellationToken, Task>? _, CancellationToken ct) => to);
        ...
        {
            // Ã¢â€â‚¬Ã¢â€â‚¬ Arrange Ã¢â€â‚¬Ã¢â€â‚¬
            ...
            // Ã¢â€â‚¬Ã¢â€â‚¬ Step 1: Create Proposal Ã¢â€â‚¬Ã¢â€â‚¬
            ...
            // Ã¢â€â‚¬Ã¢â€â‚¬ Step 2: Accept Proposal (as driver) Ã¢â€â‚¬Ã¢â€â‚¬
        ...
        public async Task AcceptProposal_ShipmentAlreadyAccepted_ThrowsInvalidOperation()
        {
            ...
            var tripPost = new TripPostRecord
            {
                Id = proposal.TripPostId!.Value, TripId = trip.Id, Status = "Open",
                PickupMode = "DirectPickup", AcceptUntil = DateTimeOffset.UtcNow.AddHours(2),
                CreatedBy = driverId, Title = "Post", CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow
            };
            ...
            _stateService.Verify(s => s.TransitionAsync(
                ...
                It.IsAny<object?>(), It.IsAny<object?>(),
                It.IsAny<Guid?>(), It.IsAny<string?>(), It.IsAny<Func<ShipmentStatusChangedEvent, CancellationToken, Task>?>(), It.IsAny<CancellationToken>()),
                Times.Never);
        }
